...
const Contact = () => {
  ...
  return (
    <div id="contact" className="max-w-[90%] mx-auto mt-10 h-full gap-5 mb-10 flex flex-col">
      {/* Main Heading */}
      <div className="text-center">
        <h1 className="font-bold text-3xl text-[#003366]" data-aos="fade-up">Contact Me</h1>
        ...
        <p className="text-lg m-3 text-[#555555]" data-aos="fade-up" data-aos-delay="200">Reach out to me for collaborations, queries, or just to say hi!</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="flex flex-col w-full md:w-1/2 p-6 rounded-lg border shadow-md" data-aos="fade-right" data-aos-delay="800">
          <div className="text-2xl mt-4">
            <h1><i className="bi bi-envelope mr-2"></i>Email</h1>
            <h1 className="text-lg mt-2">sandeepkumaronteru7777@gmail.com</h1>
          </div>
        ...
        <div className="w-full md:w-1/2 p-6 bg-green-200 rounded-lg shadow-md" data-aos="fade-left" data-aos-delay="800">
